...
def run_single_training(arg_dict):
    ...
    p = subprocess.run("python3 RunSplitTrainSeed.py" + arg_str, shell=True, 
...
if __name__ == '__main__':
    ...
    help_d = """
    RunNLNSOSeed runs a set of trainings based on all the possible combinations
    ...
    pipes = [      "ica",     "icasr", "filt"]
    tasks = ["parkinson", "alzheimer",  "bci"]
