...
if __name__ == '__main__':
    ...
    help_d = """
    RunNKFold runs a set of trainings based on all the possible combinations
    ...
    for loop.
    This is for Nested sample-based K-Fold CV CV.
    
    Example of first call:
    
    $ Python RunNKFold -d /path/to/data

    Example of another call if run fails for some reasons:

    $ Python RunNKFold -d /path/to/data -s 130
    ...
    pipes = [    "icasr",       "ica", "filt"]
    tasks = ["alzheimer", "parkinson",  "bci"]
